...
@section('body')
    <body class="text-center">
        <form class="form-signin" action=" {{ route('saveTransaction') }}" method="POST">
            ...
            <h1 class="h3 mb-3 font-weight-normal">Create new transaction</h1>
            ...
            <input type="text" id="cash" name="cash" class="form-control" placeholder="Net cash" required value="{{$transaction->cash}}">
            ...
            <input type="text" id="size" name="size" class="form-control" placeholder="Position size" required>
            ...
            <input type="text" id="strike" name="strike" class="form-control" placeholder="Strike" required>
